...
Open `http://localhost:3001/?demo=1` — renders a **synthetic sample shipment**
(embedded in `src/demoData.js` — fabricated, no real data) with no Sigma connection needed.
